...
/* Include generated dispatch declarations */
#include "lang_dispatch_generated.h"
...
void lang_dispatch_init(void) {
    /* Register all compiled-in languages using generated macro */
    LANG_DISPATCH_INIT_ALL_GENERATED()
}
